{
  ...
  inputs = {
    ...
    core-nomos.url = "github:LiGoldragon/core-nomos/6ef64cc38a104836b2b236ba4838ffd8e75dced1";
    ...
    rust-logos.url = "github:LiGoldragon/rust-logos/f92a8eccd851ebb1f8140ec42e00b04ba73758d0";
